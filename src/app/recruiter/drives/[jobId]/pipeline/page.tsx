    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <div key={round.id} className="bg-white border border-slate-200 rounded-xl p-4 flex items-start gap-4 shadow-sm group hover:border-blue-300 transition-colors">
