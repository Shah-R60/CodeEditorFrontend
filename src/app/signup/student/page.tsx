...
import { Lock, User as UserIcon, Mail, Loader2, Code2, ArrowRight, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans text-slate-900 selection:bg-blue-100">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          ...
          <Link href="/login/student" className="font-semibold text-blue-600 hover:text-blue-500 transition">
            Sign in here
          </Link>
        </p>
      </div>
